...
/**
 * Servlet implementation class SimulacionServlet
 */
@WebServlet("/SimulacionNacionalServlet")
public class SimulacionNacionalServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SimulacionNacionalServlet() {
        super();
