...
<div class= "intro" >
    <form action="LoginServlet" name="acceso">
        ...
        <br></br>
	    <br>Contraseña:</br>
	    <input type="password" name="password" required  class="userinput" value="" placeholder="Introduzca su contraseña" >
	    <br></br>
	    <br>
        <input type="submit" value="Iniciar Sesión" target="_parent" class="entrar">
    </form>
    <br></br>
